...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '逸仙中学答题库', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '逸仙中学答题库', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://woliwal.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '"逸仙中学答题库：探索知识，激发智慧，引领未来！"', // 网站关键词 英文逗号隔开
